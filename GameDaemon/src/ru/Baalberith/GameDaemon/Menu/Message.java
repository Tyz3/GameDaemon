...
public enum Message {
	...
	add_container, add_element, edit_container, edit_element, clear_container, clear_element,
	clear_property_container, clear_property_element,
	notExists_container, notExists_element, notExists_property_container, notExists_property_element,
	help_type_button_mob, help_type_button_boss, help_type_button_cmds, help_type_button_nextWay, help_type_skull, help_type_icon, help_type_loot,
	noItemInHand, noDisplayname,
	
	mobLore, bossLore, mobDisplayname, bossDisplayname, dropLoot_dropChance,
	healthBoostRaw, strengthBoostRaw, worldBoss,
	help_info, nothingShow;

	private static final int PLACEHOLDERS_LIMIT = 4;
