...
public enum Message {
	...
	help_title, help_default, help_smoder, unknownCommand, info, alreadyHas, noParty, alreadyExists, notFound,
	
	socialspy_disable, socialspy_enable,
	
	nameLength, namePattern, created, left,
	
	memberKicked, noMember, notOwner, kickYourself,
	
	playerHasParty, full, 
	
	joinRequest, joinRequested, joinAccept, joinAccepted, joinDeny, joinDenied,
	joinIgnore, joinIgnored, inviteRequest, inviteRequested, inviteAccept, 
	inviteAccepted, inviteDeny, inviteDenied, inviteIgnore, inviteIgnored, 
	
	ownerNotOnline, playerNotOnline, noRequests, alreadyRequsted,
	
	cannotChangeInDungeon, ownerInDungeon, kicked,
	
	leaveAlert, kickAlert, joinAlert, disbandAlert, 
	
	sidebar_usage, sidebar_hidden, sidebar_shown, sidebar_alreadyShown, sidebar_alreadyHidden,
	list_header, list_line, list_empty,
	
	opened, alreadyOpened, closed, alreadyClosed, cannotJoinClosed,
	
	chatActivated, chatDeactivated, chatMemberFormat, chatOwnerFormat,
	
	randomGroupNames, charset;
