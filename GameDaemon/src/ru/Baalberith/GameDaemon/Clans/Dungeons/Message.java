...
public enum Message {
	...
	noDungeon, confirm, confirmOwner, confirmed, 
	
	requirement_online, requirement_distance, requirement_key, requirement_combat, requirement_owner, requirement_completeness,
	
	partyMismatch, noSession, busy, confirmRequirement, sessionTimedOut,
	noParty, cancelled, cancelledAlert,
	
	cannotJoinCombat, cannotLeaveCombat, joinCooldownOther, selfCooldown,
	gameStartedAdminAlert, playerReady, returnKey, returnKeyFromOfflines, gameEndedTimeout,
	joinRequestSendedToMembers,
	
	hologram_title, hologram_status, hologram_topTitle, hologram_topFormat,
	
	rewarded, rewardedFromAbsent, leaveInCombat;
