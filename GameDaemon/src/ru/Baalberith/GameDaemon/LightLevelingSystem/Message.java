...
public enum Message {
	...
	description_common_title, description_common_available_yes, description_common_available_no,
	description_common_level, description_common_cost, description_common_autoReward, description_common_immutable,
	description_health, description_defense, description_attack, description_inspiration,
	
	description_brief_common, description_brief_trait,
	
	levelMenuTitle, noFreePoints, forbidden,
	
	booster_activate, booster_imposible, booster_time, booster_notify, booster_ended;
